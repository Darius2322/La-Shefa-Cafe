  ...
  return (
    <div className="min-h-screen bg-teal flex items-center justify-center px-4">
      <div className="bg-cream rounded-sm p-8 w-full max-w-sm">
        ...
        <h1 className="font-display text-2xl text-brown text-center mb-1">Staff Login</h1>
        <p className="text-brown/60 text-sm text-center mb-8">La Shefa Cafe team portal</p>
